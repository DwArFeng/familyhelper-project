...
@Table(name = "tbl_memo_remind_driver_support")
public class HibernateMemoRemindDriverSupport implements Bean {

    private static final long serialVersionUID = 1949558625224983420L;
    ...
    public HibernateMemoRemindDriverSupport() {
    }
