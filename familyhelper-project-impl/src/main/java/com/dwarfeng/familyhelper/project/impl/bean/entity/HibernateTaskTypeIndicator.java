...
@Table(name = "tbl_task_type_indicator")
public class HibernateTaskTypeIndicator implements Bean {

    private static final long serialVersionUID = -6457106892432432137L;
    ...
    public HibernateTaskTypeIndicator() {
    }
    ...
    public String toString() {
        return "HibernateTaskTypeIndicator{" +
                "stringId='" + stringId + '\'' +
                ", label='" + label + '\'' +
                ", remark='" + remark + '\'' +
                '}';
