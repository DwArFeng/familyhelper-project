...
public class LogPusher extends AbstractPusher {
    ...
    @Override
    public void memoRemindHappened(MemoRemindInfo memoRemindInfo) throws HandlerException {
        String title = "备忘录提醒事件:";
        String message = Objects.toString(memoRemindInfo);
        logData(title, message);
    }

    @Override
    public void memoRemindDriveReset() throws HandlerException {
        String title = "备忘录提醒驱动重置事件:";
